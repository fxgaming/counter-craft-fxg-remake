...
public class UpdateUtil {
	public static Object[] checkThroughFile(URL uri) {
		...
		catch (Exception espan) {return new Object[]{"0", "0", new String[]{"0"}, "", ""};}
	}
	...
	public static Date getDateGMT() {
		...
		BufferedReader reader = null;
		try {
			reader = new BufferedReader(new InputStreamReader(new URL("https://time100.ru/api.php").openStream()));
		} catch(Exception e){}
		
			try {
				info = reader.readLine();
			} catch(IOException e){}
		Integer infotoint = Integer.valueOf(info);
		Date d = new Date();
		d.setDate(infotoint);
		return d;
	}
