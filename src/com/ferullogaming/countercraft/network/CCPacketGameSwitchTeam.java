...
public class CCPacketGameSwitchTeam extends CCPacket {
   public static Packet buildPacket() {
      ...
      try {
         data.write(NetworkManager.getIDFromPacket(CCPacketGameSwitchTeam.class));
   ...
   public void execute(DataInputStream stream, EntityPlayer player, Object[] extradata, Side side) {
      if (!player.worldObj.isRemote && GameManager.instance().getPlayerGame(player) != null) {
         ...
         game.getPlayerEventHandler().onPlayerSwitchTeam(player);
      }
