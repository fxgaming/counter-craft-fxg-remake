...
public class PacketRequestedTrading extends G_TcpPacketCustomPayload {
   private FDSTagCompound tag = new FDSTagCompound("tradeHandler");
   ...
   public void processPacketOnMainThread(G_ITcpConnectionHandler par1) throws IOException {
      ClientManager.instance().getTradeHandler().readFromFDS(this.tag);
   }
}
