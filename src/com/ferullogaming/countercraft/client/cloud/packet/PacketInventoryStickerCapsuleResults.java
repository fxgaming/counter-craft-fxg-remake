...
import com.ferullogaming.countercraft.client.gui.inventory.GuiCCMenuOpenCapsule;
...
public class PacketInventoryStickerCapsuleResults extends G_TcpPacketCustomPayload {
   ...
   public void processPacketOnMainThread(G_ITcpConnectionHandler par1) throws IOException {
      ...
      if (gui != null && gui instanceof GuiCCMenuOpenCapsule) {
         ((GuiCCMenuOpenCapsule)gui).onResultsIn(this.stacks);
      }
