...
import com.ferullogaming.countercraft.client.model.ModelGrenadeSmoke;
...
public class RenderGrenadeSmokeHand implements IItemRenderer {
   public static ResourceLocation res = new ResourceLocation("countercraft:textures/models/grenadesmoke.png");
   ...
   protected ModelGrenadeSmoke model = new ModelGrenadeSmoke();
