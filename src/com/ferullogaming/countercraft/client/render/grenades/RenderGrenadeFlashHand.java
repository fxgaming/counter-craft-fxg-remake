...
public class RenderGrenadeFlashHand implements IItemRenderer {
   public static ResourceLocation res = new ResourceLocation("countercraft:textures/models/grenadeflash.png");
