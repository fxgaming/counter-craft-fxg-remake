...
public class RenderGrenadeFireHand implements IItemRenderer {
   public static ResourceLocation res = new ResourceLocation("countercraft:textures/models/grenadefire.png");
