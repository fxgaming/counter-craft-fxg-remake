...
import com.ferullogaming.countercraft.client.model.ModelGrenadeFrag;
...
public class RenderGrenadeHEHand implements IItemRenderer {
   public static ResourceLocation res = new ResourceLocation("countercraft:textures/models/grenadefrag.png");
   ...
   protected ModelGrenadeFrag model = new ModelGrenadeFrag();
