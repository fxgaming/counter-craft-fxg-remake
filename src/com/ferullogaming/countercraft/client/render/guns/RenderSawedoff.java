...
import com.ferullogaming.countercraft.client.model.guns.ModelSawedoff;
import net.minecraft.entity.Entity;
import net.minecraft.entity.player.EntityPlayer;
import net.minecraft.item.ItemStack;
import org.lwjgl.opengl.GL11;

public class RenderSawedoff extends RenderGun {
   ...
   public void renderOnHUD(ItemStack stack, double x, double y) {
      this.renderGunGUI(stack, x - 25.0D, y, 46.0D, 0.0D, 0.0D, 0.0D);
   }

   public void renderInventorySlot(ItemStack stack, double x, double y) {
      this.renderGunGUI(stack, x + 13.0D, y - 2.0D, 24.0D, -20.0D, 0.0D, 0.0D);
   }
   
   public void renderSkins(ItemStack stack, double x, double y){ this.renderGunGUI2(stack, x + 13.0D, y - 2.0D, 24.0D, -20.0D, 0.0D, 0.0D); }

   public void renderInspection(ItemStack stack, double x, double y, double rot) {
      this.renderGunGUIPre(stack, x + 4.0D, y - 1.0D, 160.0D, 0.0D, rot, 0.0D);
   ...
   public ModelGun getGunModel() {
      return new ModelSawedoff();
   }

   public String getTexture() {
      return "sawedoffmodel";
   }
