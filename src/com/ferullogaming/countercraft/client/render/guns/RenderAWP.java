...
import com.ferullogaming.countercraft.client.model.guns.ModelAWP;
...
public class RenderAWP extends RenderGun {
   ...
   public void renderOnHUD(ItemStack stack, double x, double y) {
      this.renderGunGUI(stack, x - 26.0D, y - 3.0D, 40.0D, 0.0D, 0.0D, 0.0D);
   }

   public void renderInventorySlot(ItemStack stack, double x, double y) {
      this.renderGunGUI(stack, x + 11.0D, y - 6.0D, 17.0D, -20.0D, 0.0D, 0.0D);
   }

   public void renderSkins(ItemStack stack, double x, double y){ this.renderGunGUI2(stack, x + 11.0D, y - 6.0D, 17.0D, -20.0D, 0.0D, 0.0D); }
