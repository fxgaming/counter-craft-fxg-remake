...
import com.ferullogaming.countercraft.client.model.ModelSticker;
...
public class RenderSticker implements IItemRenderer, IRenderOnGUI {
   protected ResourceLocation res = new ResourceLocation("countercraft:textures/models/stickercase.png");
   protected ModelBase model = new ModelSticker();
   ...
   public void renderInventorySlot(ItemStack stack, double x, double y) {
      this.renderDisplayed(stack, x - 14.0D, y + 7.55D, 14.5D, false, 0.0D);
   }

   public void renderInspection(ItemStack stack, double x, double y, double rot) {
      this.renderDisplayed(stack, x - 70.0D, y + 80.0D, 70.0D, false, rot);
   }
