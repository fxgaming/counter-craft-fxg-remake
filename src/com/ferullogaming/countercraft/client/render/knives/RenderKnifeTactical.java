...
import com.ferullogaming.countercraft.client.model.knives.ModelKnifeTactical;
import net.minecraft.client.model.ModelBase;
import net.minecraft.item.ItemStack;
import net.minecraftforge.client.IItemRenderer.ItemRenderType;
import org.lwjgl.opengl.GL11;

public class RenderKnifeTactical extends RenderKnife {
   public RenderKnifeTactical(String par1) {
      super(par1);
   }
