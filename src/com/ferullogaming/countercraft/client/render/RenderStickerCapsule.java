...
import com.ferullogaming.countercraft.client.model.ModelStickerCapsule;
...
public class RenderStickerCapsule implements IItemRenderer, IRenderOnGUI {
   private ResourceLocation res;
   private ModelStickerCapsule model = new ModelStickerCapsule();

   public RenderStickerCapsule(String par1) {
   ...
   public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
      ...
      if (type == ItemRenderType.EQUIPPED) {
         ...
         if (type == ItemRenderType.INVENTORY) {
            ...
            GL11.glScaled(scale, scale, scale);
            GL11.glRotated(180.0D, 0.0D, 0.0D, 1.0D);
            GL11.glTranslated(-0.2D, -0.5D, -0.2D);
            this.model.render((Entity)null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F);
            GL11.glPopMatrix();
         }
      }
   ...
   public void renderInventorySlot(ItemStack stack, double x, double y) {
	   this.renderCaseDisplayed(stack, x - 33.0D, y - 11.0D, 25.0D, false, 0.0D);
   }
