...
import com.ferullogaming.countercraft.client.model.hats.ModelHatSpider;
...
public class RenderHatSpider extends RenderHat {
   public RenderHatSpider() {
      super("spiderhat");
   }
   ...
   public void renderInspection(ItemStack stack, double x, double y, double rot) {
      this.renderDisplayed(stack, x - 100.0D, y + 60.0D, 100.0D, false, rot);
   }
