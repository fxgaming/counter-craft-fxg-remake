...
public class GuiCCDDMItemClickedCase extends GuiFGDropDownMenu {
   private CloudItemStack stack;

   public GuiCCDDMItemClickedCase(GuiScreen par1, int par2, int par3, int par4, int par5, CloudItemStack stack) {
   ...
   public void onOptionClicked(int par1) {
      if (par1 == 1) {
         Minecraft.getMinecraft().displayGuiScreen(new GuiCCMenuOpenCase(this.stack));
      }
