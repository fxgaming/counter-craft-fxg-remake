...
public class MapMode {
   ...
   public MapMode(MinimapConfig config, String configCategory) {
      this.config = config;
   ...
   public Double blockXZtoScreenXY(MapView mapView, double bX, double bZ) {
      double xNorm = (bX - mapView.getX()) / mapView.getWidth();
      double zNorm = (bZ - mapView.getZ()) / mapView.getHeight();
      return new Double((double)this.w * xNorm, (double)this.h * zNorm);
   }

   public Double getClampedScreenXY(MapView mapView, double bX, double bZ) {
      ...
      return new Double((double)this.w * xRel, (double)this.h * zRel);
   }
}
