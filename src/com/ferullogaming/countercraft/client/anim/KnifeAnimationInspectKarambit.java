...
public class KnifeAnimationInspectKarambit extends GunAnimation {
   ...
   public void doRender(ItemStack par1, float par2) {
      ...
      GL11.glTranslatef(transprogress * 0.4F, transprogress * 1.2F, transprogress * 1.2F);
   ...
   public void doRenderHand(ItemStack par1, float par2, boolean par3) {
      ...
      if (par3) {
         ...
         GL11.glTranslatef(transprogress * 0.4F, transprogress * 0.7F, -transprogress * 0.5F);
